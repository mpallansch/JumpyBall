...
function init() {
    ...
    if (localStorage.getItem("unlocks") === null) {
        unlocks = new Array(true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
        store(0);
    }
    if (localStorage.getItem("charIndex") === null) {
        charIndex = 0;
        store(1);
    }
    retrieve();
...
function retrieve() {
    ...
    charIndex = parseInt(localStorage.getItem("charIndex"));
}
